          ...
          <div className="pt-32 pb-12 md:pt-40 md:pb-20">
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-xl text-gray-600 mb-5">
                ...
                property rights related to it, still belong to Ekrpt Mobile SMS.
              </p>
              <p className="text-xl text-gray-600 mb-5">
                Ekrpt Mobile SMS is committed to ensuring that the app is as useful and
              ...
              <p className="text-xl text-gray-600 mb-5">
                You should be aware that there are certain things that Ekrpt Mobile SMS
                ...
                provider, but Ekrpt Mobile SMS cannot take responsibility for the app
              ...
              <p className="text-xl text-gray-600 mb-5">
                Along the same lines, Ekrpt Mobile SMS cannot always take responsibility
                ...
                turn it on to avail the Service, Ekrpt Mobile SMS cannot accept
                responsibility.
              </p>
              <p className="text-xl text-gray-600 mb-5">
                With respect to Ekrpt Mobile SMS's responsibility for your use of the
                ...
                to us so that we can make it available to you. Ekrpt Mobile SMS accepts
              ...
              <p className="text-xl text-gray-600 mb-5">
                ...
                want to keep using the app. Ekrpt Mobile SMS does not promise that it
              ...
              <p className="text-xl text-gray-600 mb-5">
                ...
                Conditions, do not hesitate to contact me at support@ekrpt.com.
              </p>
            </div>
          </div>
        </div>
